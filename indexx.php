...
<div class="wrapper">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <?php
              $alertas = mysqli_query($con,"select * from alerta where cliente_id = '".$_SESSION['ID']."'")
              $cant = mysqli_num_rows($alertas);
         ...
         ?>
          ...
          <li class="dropdown notifications-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="label label-warning"><?php echo $cant ?></span>
            </a>
            <script>
              function cambiar(v){
            ...
            <ul class="dropdown-menu">
              <li class="header">Tienes <?php echo $cant ?> notificaciones</li>
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">
                  ...
                  <?php
                    ...
                    while($row = mysqli_fetch_assoc($alertas)){
                      # code...
                      if($row['visto']==0){
                        ?>
                       <li>
                              <a data-toggle='modal' data-target='#modal-danger' <?php echo   "onclick = 'cambiar(".$row['id'].")'" ?> >
  ...
  <div class="content-wrapper">
    ...
    <?php
$query = mysqli_query($con,"select * from tope where id_usuario = '".$_SESSION['ID']"'")
...
$var = mysqli_query($con , "select * from temperatura limit 1");
