      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="index.php"><i class="fa fa-circle-o"></i> Portada Simple</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Temperatura</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="row">
        <!-- Left col -->
        	<?php
        		$query = $database->prepare("select * from Sensor where nombre = 'Temperatura' and Cliente_Rut = '".$_SESSION['RUT']."'");
        		$query->execute() ;
