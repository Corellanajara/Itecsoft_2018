...
<!-- iCheck -->
          <div class="box box-success">
            <div class="box-header">
              <h3 class="box-title">Seleccione los sensores que posee</h3>
            </div>
            <div class="box-body">
              <!-- Minimal style -->
              ...
              <form action="config.php" method="post">
                <label>
                  <input type="checkbox" class="minimal" id="temperatura" name="temperatura"  value="temperatura" >
                  Temperatura
                </label>
                <br>  
                <label>
                  <input type="checkbox" class="minimal" name="humedad" value="humedad" id="humedad">
                  Humedad
                </label>
                <br>
                <label>
                  <input type="checkbox" class="minimal" name="presion" value="presion"  id="presion">
                  Presión
                </label>
                <br>  
                <label>
                  <input type="checkbox" class="minimal" name="radiacion" value="radiacion" id="radiacion">
                  radiacion
                </label>
                <br>  
                ...
                <br>  
                <label>
                  <input type="checkbox" class="minimal" name="precipitacion" value="precipitacion" id="precipitacion">
                  Precipitacion
                </label>
                <br>  
                <label>
                  <input type="checkbox" class="minimal" name="humedadr" value="humedadr" id="humedadr">
                  Humedad Relativa
                </label>
                <br>  
                <label>
                  <input type="checkbox" class="minimal" name="mosture" value="mosture" id="mosture">
                  Soul mosture
                </label>
                <br>  
                <label>
                  <input type="checkbox" class="minimal" name="viento" value="viento" id="viento">
                  Viento
                </label>
